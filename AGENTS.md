...
- Use REST API.
- All user-specific endpoints must require JWT, except register, login, avatars if public, and static media.
- Do not return password hashes.
- Use request/response DTO models for API requests and responses, placed in `Models`.
