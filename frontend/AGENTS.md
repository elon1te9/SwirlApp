...
- `core` — shared constants, API client, token storage, error handling, utilities.
- `data` — API classes, DTOs, repositories.
- `domain` — app models and domain services.
- `presentation` — screens, widgets, state providers/controllers.
